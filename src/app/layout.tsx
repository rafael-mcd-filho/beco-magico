...
export default function RootLayout({
  ...
  return (
    <html lang="pt-BR" className={`${wizardWorld.variable} ${cinzel.variable} ${inter.variable}`}>
      <head>
        <link rel="preload" as="image" href="/images/hero/heromobile.png" media="(max-width: 767px)" />
        <link rel="preload" as="image" href="/images/hero/hero.png" media="(min-width: 768px)" />
      </head>
