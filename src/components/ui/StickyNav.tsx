      ...
      {visible && (
        ...
        >
          <div className="mx-auto max-w-content px-6 md:px-8 py-3 md:py-4 flex items-center justify-between gap-4">
            <a
              href="#"
              className="font-display text-base md:text-lg font-semibold text-beco-gold whitespace-nowrap"
            >
              Beco Mágico
            </a>
            ...
            <a
              href="#formulario"
              className="inline-flex items-center justify-center rounded-pill bg-beco-gold text-beco-bg font-sans font-semibold text-sm px-4 md:px-5 py-2 md:py-2.5 hover:bg-beco-goldGlow transition-all whitespace-nowrap shrink-0"
            >
